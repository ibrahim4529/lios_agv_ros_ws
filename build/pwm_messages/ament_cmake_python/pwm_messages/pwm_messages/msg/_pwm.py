...
class Metaclass_Pwm(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('pwm_messages')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'pwm_messages.msg.Pwm')
            logger.debug(
...
class Pwm(metaclass=Metaclass_Pwm):
    ...
    def __init__(self, **kwargs):
        ...
        self.pwm3 = kwargs.get('pwm3', int())
        self.pwm4 = kwargs.get('pwm4', int())
    ...
    def __eq__(self, other):
        ...
        if self.pwm2 != other.pwm2:
            return False
        if self.pwm3 != other.pwm3:
            return False
        if self.pwm4 != other.pwm4:
            return False
        return True
    ...
    def pwm3(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'pwm3' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'pwm3' field must be an integer in [-2147483648, 2147483647]"
        self._pwm3 = value
    ...
    def pwm4(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'pwm4' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'pwm4' field must be an integer in [-2147483648, 2147483647]"
        self._pwm4 = value
