...
pwm_messages__msg__Pwm__are_equal(const pwm_messages__msg__Pwm * lhs, const pwm_messages__msg__Pwm * rhs)
{
  ...
  // pwm3
  if (lhs->pwm3 != rhs->pwm3) {
    return false;
  }
  // pwm4
  if (lhs->pwm4 != rhs->pwm4) {
    return false;
  }
  return true;
}
  ...
  pwm_messages__msg__Pwm * output)
{
  ...
  // pwm3
  output->pwm3 = input->pwm3;
  // pwm4
  output->pwm4 = input->pwm4;
  return true;
}
...
pwm_messages__msg__Pwm__create()
{
  ...
  pwm_messages__msg__Pwm * msg = (pwm_messages__msg__Pwm *)allocator.allocate(sizeof(pwm_messages__msg__Pwm), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pwm_messages__msg__Pwm));
  bool success = pwm_messages__msg__Pwm__init(msg);
  if (!success) {
...
pwm_messages__msg__Pwm__destroy(pwm_messages__msg__Pwm * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    pwm_messages__msg__Pwm__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
pwm_messages__msg__Pwm__Sequence__init(pwm_messages__msg__Pwm__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pwm_messages__msg__Pwm * data = NULL;

  if (size) {
    data = (pwm_messages__msg__Pwm *)allocator.zero_allocate(size, sizeof(pwm_messages__msg__Pwm), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pwm_messages__msg__Pwm__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        pwm_messages__msg__Pwm__fini(&data[i - 1]);
      }
...
pwm_messages__msg__Pwm__Sequence__fini(pwm_messages__msg__Pwm__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      pwm_messages__msg__Pwm__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pwm_messages__msg__Pwm__Sequence * array = (pwm_messages__msg__Pwm__Sequence *)allocator.allocate(sizeof(pwm_messages__msg__Pwm__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pwm_messages__msg__Pwm__Sequence__init(array, size);
  if (!success) {
...
pwm_messages__msg__Pwm__Sequence__destroy(pwm_messages__msg__Pwm__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pwm_messages__msg__Pwm__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pwm_messages__msg__Pwm__Sequence__are_equal(const pwm_messages__msg__Pwm__Sequence * lhs, const pwm_messages__msg__Pwm__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pwm_messages__msg__Pwm__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pwm_messages__msg__Pwm__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pwm_messages__msg__Pwm);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pwm_messages__msg__Pwm * data =
      (pwm_messages__msg__Pwm *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pwm_messages__msg__Pwm__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pwm_messages__msg__Pwm__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!pwm_messages__msg__Pwm__copy(
