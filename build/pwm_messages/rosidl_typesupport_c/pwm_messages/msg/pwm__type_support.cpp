...
static const _Pwm_type_support_symbol_names_t _Pwm_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pwm_messages, msg, Pwm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pwm_messages, msg, Pwm)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pwm_messages, msg, Pwm)() {
  return &::pwm_messages::msg::rosidl_typesupport_c::Pwm_message_type_support_handle;
}
