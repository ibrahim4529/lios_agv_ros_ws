...
static const _Pwm_type_support_symbol_names_t _Pwm_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pwm_messages, msg, Pwm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pwm_messages, msg, Pwm)),
  }
};
...
{
  return &::pwm_messages::msg::rosidl_typesupport_cpp::Pwm_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pwm_messages, msg, Pwm)() {
  return get_message_type_support_handle<pwm_messages::msg::Pwm>();
}
